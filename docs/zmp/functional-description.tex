...
Poza typowymi funkcjonalnościami systemu udostępniona publicznie jest również dokumentacja API w standardzie \verb|OpenAPI|, które można znaleźć pod adresem URL:\newline https://sgorski00.github.io/expense-splitter-api/

Można w niej znaleźć pełną dokumentację wszystkich funkcjonalności i enpointów końcowych.
