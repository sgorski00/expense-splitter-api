...
public class GlobalExceptionHandler {
          ...
          @Content(
              ...
              schema =
                  @Schema(
                      ...
                      description =
                          "RFC 7807 Problem Details response with 404 status and resource not found message.")))
          ...
          @Content(
              ...
              schema =
                  @Schema(
                      implementation = ProblemDetail.class,
                      description =
                          "RFC 7807 Problem Details response with 409 Conflict status and user already exists message.")))
          ...
          @Content(
              ...
              schema =
                  @Schema(
                      implementation = ProblemDetail.class,
                      description =
                          "RFC 7807 Problem Details response indicating that password must be changed.")))
          ...
          @Content(
              ...
              schema =
                  @Schema(
                      implementation = ProblemDetail.class,
                      description =
                          "RFC 7807 Problem Details response indicating account must be linked.")))
          ...
          @Content(
              ...
              schema =
                  @Schema(
                      implementation = ProblemDetail.class,
                      description =
                          "RFC 7807 Problem Details response indicating invalid OAuth2 provider data.")))
  public ProblemDetail handleOAuth2InvalidAttributesException(OAuth2InvalidAttributesException ex) {
    var status = HttpStatus.BAD_REQUEST;
    var problemDetail =
        ProblemDetail.forStatusAndDetail(
            status, "Invalid data received from OAuth2 provider. Please try logging in again.");
  ...
  public ProblemDetail handleAuthenticationException(AuthenticationException ex) {
    ...
    var problemDetail =
        ProblemDetail.forStatusAndDetail(
            status, "Authentication failed. Please check your credentials and try again.");
          ...
          @Content(
              ...
              schema =
                  @Schema(
                      implementation = ProblemDetail.class,
                      description =
                          "RFC 7807 Problem Details response with 403 Forbidden status.")))
  public ProblemDetail handleAccessDeniedException(AccessDeniedException ex) {
    var status = HttpStatus.FORBIDDEN;
    var problemDetail =
        ProblemDetail.forStatusAndDetail(
            status, "Access denied. You do not have permission to access this resource.");
          ...
          @Content(
              ...
              schema =
                  @Schema(
                      ...
                      description =
                          "RFC 7807 Problem Details response with 400 Bad Request status.")))
  public ProblemDetail handleInvalidFriendshipOperationException(
      InvalidFriendshipOperationException ex) {
    var status = HttpStatus.BAD_REQUEST;
    var problemDetail = ProblemDetail.forStatusAndDetail(status, ex.getMessage());
  ...
  @ApiResponse(
      responseCode = "500",
      description =
          "An unexpected server error occurred. The error details are provided in the response body in RFC 7807 Problem Details format.",
      content =
          @Content(
              mediaType = "application/json",
              schema =
