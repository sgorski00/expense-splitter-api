...
/**
 * Thrown when an invalid operation is attempted on a friendship relationship.
 * <br>
 * Common cases:
 * - Trying to accept a friendship request as a requester
 * - Trying to invite yourself as a friend
 */
