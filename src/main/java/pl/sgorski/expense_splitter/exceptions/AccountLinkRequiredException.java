...
/**
 * Thrown when oauth2 link mode is required to perform an action
 * <br>
 * This occurs when local user with matching email already exists when trying to log in with an OAuth2 provider
 */
