...
public class JwtAuthenticationFilterTest {
    ...
    @Test
    void doFilterInternal_shouldSetAuthentication_whenTokenIsValidAndContextAuthIsNull() throws Exception {
    ...
    @Test
    void doFilterInternal_shouldNotSetAuthentication_whenTokenIsValidButContextAuthIsNotNull() throws Exception {
        var token = "validToken";
        var header = "Bearer " + token;
        var email = "user@example.com";
        when(request.getHeader(anyString())).thenReturn(header);
