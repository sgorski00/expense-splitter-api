...
public class LocalAuthServiceTest {
    ...
    void registerUser_shouldThrowException_whenUserAlreadyExists() {
        ...
        assertThrows(UserAlreadyExistsException.class, () -> localAuthService.registerUser(registerCommand));
        verify(userService, times(1)).isUserPresent(eq(email));
    ...
    void login_shouldThrowException_whenPrincipalIsNull() {
        ...
        var exception = assertThrows(NullPointerException.class, () -> localAuthService.login(loginCommand));
    ...
    void setLocalPassword_shouldThrowException_whenUserAlreadyHasPassword() {
        ...
        assertThrows(PasswordOperationException.class, () -> localAuthService.setLocalPassword(user, rawPassword));
        verifyNoInteractions(userService);
    ...
    void changePassword_shouldThrowException_whenUserHasNoPassword() {
        ...
        assertThrows(PasswordOperationException.class, () -> localAuthService.changePassword(user, oldPassword, rawPassword));
        verifyNoInteractions(userService);
        verifyNoInteractions(passwordEncoder);
    ...
    void changePassword_shouldThrowException_whenOldPasswordIsInvalid() {
        ...
        assertThrows(InvalidPasswordException.class, () -> localAuthService.changePassword(user, oldPassword, rawPassword));
        verifyNoInteractions(userService);
