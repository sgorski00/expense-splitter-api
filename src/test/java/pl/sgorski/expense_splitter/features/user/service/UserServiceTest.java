...
public class UserServiceTest {
    ...
    void getUserWithIdentities_shouldReturnUser_whenUserExists() {
        when(userRepository.findWithIdentitiesByIdAndDeletedAtIsNull(eq(userId))).thenReturn(Optional.of(user));
    ...
    void getUserWithIdentities_shouldThrowUserNotFound_whenUserNotFound() {
        when(userRepository.findWithIdentitiesByIdAndDeletedAtIsNull(eq(userId))).thenReturn(Optional.empty());
